...
var Locale = class _Locale {
  ...
  static copyLocaleNoNikud(data) {
    ...
    for (const [key, val] of Object.entries(strs)) {
      m2[key] = [_Locale.hebrewStripNikkud(val[0])];
    }
    return {
...
var poHeNoNikud = Locale.copyLocaleNoNikud(poHe);
...
@hebcal/hdate/dist/esm/greg.js:
  (*! @hebcal/hdate v0.14.5, distributed under GPLv2 https://www.gnu.org/licenses/gpl-2.0.txt *)
